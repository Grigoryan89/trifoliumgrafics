...
@section('content')
    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                <div class="col-sm-8"><h1>Lazerayin tpagrutyan <b>Մանրամասներ</b></h1></div>
                <div class="col-sm-4">
                    <button type="button" class="btn btn-info add-new" data-toggle="modal"
                            data-target="#addModal"><i class="fa fa-plus"></i> Ավելացնել
                    </button>
                </div>
            </div>
        </div>
                    ...
                    <td>
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                                <a href="{{route('lasers.edit',$item->id)}}" class="edit" title="Edit"
                            ...
                            <button type="button" data-toggle="modal" class="deleteImage"
                                    ...
                                    data-url="{{route('lasers.destroy', $item->id) }}"
                                    data-row="{{$item->id}}"
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('lasers.store')}}" method="post" enctype="multipart/form-data">
                    @method('POST') @csrf
